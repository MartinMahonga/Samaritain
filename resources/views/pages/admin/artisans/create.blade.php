...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-700 dark:text-gray-200">Ajouter un artisan</h1>
            <p class="text-gray-500 dark:text-gray-400 text-xs mt-1">Créez un profil professionnel pour un artisan ne pouvant pas s'inscrire lui-même.</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-6 md:p-8">
                <form action="{{ route('admin.artisans.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <x-form.input name="business_name" label="Nom de l'entreprise" placeholder="Ex: SARL BTP Congo" icon="building-2" required />
                            <x-form.input name="profession" label="Profession" placeholder="Ex: Maçon, Électricien, Plombier" icon="briefcase" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <x-form.input name="city" label="Ville" placeholder="Ex: Brazzaville" icon="map-pin" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <x-form.textarea name="bio" label="Description" placeholder="Présentez l'entreprise, ses services, son savoir-faire..." rows="5" />
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <x-form.file-input name="avatar" label="Photo de profil" accept="image/*" />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Max 2 Mo. Formats : JPG, PNG, WebP</p>
                            </div>
                            <div>
                                <x-form.file-input name="cover" label="Photo de couverture" accept="image/*" />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Max 5 Mo. Formats : JPG, PNG, WebP</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm text-primary-800 dark:text-primary-300">
                                    Le profil sera directement créé comme vérifié et actif. Les réalisations pourront être ajoutées ultérieurement depuis la fiche de l'artisan.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                        <x-btn href="{{ route('admin.artisans.index') }}" style="outline" class="dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
                            Annuler
                        </x-btn>
