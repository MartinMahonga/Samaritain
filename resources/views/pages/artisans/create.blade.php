        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <p class="text-white">Créez votre profil professionnel et rejoignez notre marketplace</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="p-6 md:p-8">
                <form action="{{ route('artisan.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                            <div class="p-1.5 bg-primary/30 rounded-lg">
                                <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="border border-accent rounded-xl p-4 bg-sidebar">
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                @foreach ($categories as $category)
                                    <label
                                        class="flex items-center gap-2 cursor-pointer hover:bg-accent p-2 rounded-lg transition-colors">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <x-form.file-input name="avatar" label="Avatar" accept="image/*"
                                helper="Max 2 Mo. Formats : JPG, PNG, WebP" />
                            <x-form.file-input name="cover" label="Photo de couverture" accept="image/*"
                                helper="Max 5 Mo. Formats : JPG, PNG, WebP" />
                        </div>
                    </div>
