...
class ArtisanProjectController extends Controller
{
    public function index(Artisan $artisan)
    {
        ...
        return view('pages.admin.artisans.projects.index', compact('artisan', 'projects'));
    }
    ...
    public function create(Artisan $artisan)
    {
        ...
        return view('pages.admin.artisans.projects.create', compact('artisan'));
    }
    ...
    public function store(StoreArtisanProjectRequest $request, Artisan $artisan)
    {
        ...
        return redirect()->route('admin.artisans.projects.index', $artisan)
    ...
    public function edit(Artisan $artisan, ArtisanProject $project)
    {
        ...
        return view('pages.admin.artisans.projects.edit', compact('artisan', 'project'));
    }
